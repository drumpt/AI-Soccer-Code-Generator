...
+ '</category>'
+ '<sep></sep>'
+ '<category name="Logic" colour="#d56428">'
...
+ '</category>'
+ '<category name="Loops" colour="#506c31">'
...
+ '</category>'
+ '<category name="Math" colour="#31446c">'
...
+ '</category>'
+ '<category name="Lists" colour="#8d8680">'
...
+ '</category>'
+ '<sep></sep>'
+ '<category name="Variables" colour="#73225c" custom="VARIABLE"></category>'
+ '<category name="Functions" colour="#432362" custom="PROCEDURE"></category>'
+ '</xml>';
